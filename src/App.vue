...
---------------------------------------- */
footer {
    background-image: url(./assets/logo-variant-2.svg);
...
.sd-outro-quick-links-item:hover {
    opacity: 1;
}

.sd-outro-quick-links-item-title {
    position: relative;
    display: inline-block;
    overflow: hidden;
}
.sd-outro-quick-links-item:hover .sd-outro-quick-links-item-title span {
...
.sd-outro-quick-links-item-title span {
    display: none;
}
.sd-outro-quick-links-item:hover .sd-outro-quick-links-item-title span:before {
...
.sd-outro-quick-links-item:hover .sd-outro-quick-links-item-title span:after {
...
.sd-outro-quick-links-item-title span:after, .sd-outro-quick-links-item-title span:before {
...
.sd-outro-quick-links-item-title span:before {
    top: 0;
    -webkit-transform: skewY(0);
    -moz-transform: skewY(0);
    -ms-transform: skewY(0);
...
.sd-outro-quick-links-item-title span:after {
    top: 105%;
    -webkit-transform: skewY(7deg);
    -moz-transform: skewY(7deg);
    -ms-transform: skewY(7deg);
...
.-sd-nav-scroll {
    background-color: #fff;
    padding-bottom: 11px;
    -webkit-box-shadow: -1px 7px 5px -2px rgb(0 0 0 / 17%);
    box-shadow: -1px 7px 5px -2px rgb(0 0 0 / 17%);
...
.sd-nav__menu .sd-nav__list li .nav-link {
    margin-left: 25px;
    color: #000 !important;
    font-size: 15px;
    text-transform: capitalize;
    font-family: "Neue Machina",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif;
    font-weight: 400;
    /* opacity: .6; */
...
.sd-home-section {
    position: relative;
    z-index: 0;
    padding-top: calc(7rem + 23vw);
    padding-bottom: 7rem;
}

@media only screen and (min-width: 961px) {
    .sd-home-section {
        padding-top: calc(11rem + 6vw);
        padding-bottom: 7rem;
    }
}
...
@media only screen and (min-width: 694px) {
    .sd-home-section {
        padding-top: calc(11rem + 11vw);
    }
}

@media only screen and (min-width: 541px) {
    .sd-home-section, .intro, .news__inner {
        padding-top: calc(2rem + 11vw);
    }
}
...
@media (min-width: 768px) {
    .sd-btn_sign-bound span {
        padding: 0 21px;
        -webkit-animation: sd-btn_sign-marquee 2s linear infinite;
        -moz-animation: sd-btn_sign-marquee 2s linear infinite;
        -o-animation: sd-btn_sign-marquee 2s linear infinite;
        animation: sd-btn_sign-marquee 2s linear infinite;
    }
}

@media (min-width: 1200px) {
    .sd-btn_sign-bound span:after {
        padding: 0 25px;
    }
}
...
@-webkit-keyframes sd-btn_sign-marquee {
    0% {
        -webkit-transform: translate3d(0,0,0);
        -moz-transform: translate3d(0,0,0);
        transform: translate3d(0,0,0);
...
.sd-nav__menu .sd-nav__list li .nav-link:hover {
    opacity: .6!important;
    color: rgb(17, 17, 17)!important;
}

.sd-nav .sd-nav__menu .sd-nav__btns>:first-child {
    /* margin-right: 20px; */
}

.sd-mobile-nav__menu ul.small-menu {
    padding: 10px 35px 0 35px;
    /* opacity: 0; */
}

.sd-mobile-nav__menu ul.small-menu.is--active {
    animation: slideInMenuItem .6s ease forwards;
}

.sd-mobile-nav__menu ul li.is-active {
    animation: slideInMenuItem .6s ease forwards;
}

.sd-mobile-nav__menu ul.small-menu li {
    margin-bottom: 0px;
    margin-top: 12px;
    padding: 10px 0;
}

.sd-mobile-nav__menu ul li {
    list-style: none;
    /* opacity: 0; */
    margin-bottom: 15px;
}

.sd-mobile-nav__menu ul.small-menu li .a {
    font-size: 1.5rem;
    opacity: .8;
    line-height: 0.7;
    font-weight: 500;
...
ul.sd-sidebar-panel-nav {
    list-style-type: none;
}

ul.sd-sidebar-panel-nav > li > a {
    color: #fff;
...
ul.sd-sidebar-panel-nav > li.is--active {
    animation: slideInMenuItem .6s ease forwards;
}
...
.sd-modal-backdrop.fade {
    opacity: 0;
}

.sd-modal-backdrop.show {
    opacity: .9;
}
...
.sd-home-section.is--active,
.sd-why--section.is--active {
    z-index: -1;
}
...
.hero-title span {
    ...
    -webkit-text-fill-color: #FAD202;
}

.hero-text, .activities-text {
    font-family: 'Neue Machina';
    font-weight: 500;
    font-size: 17px;
    color: #000;
...
.search-bar .form-group:first-of-type::after{
    display: block;
    width: 1px;
    height: 60%;
    content: '';
...
.label-wrapper-inner-field::placeholder {
    color: #6D6D6D;
    font-family: 'Neue Machina';
    font-size: 17px;
    font-weight: 200px;
...
.explore-title span {
    -webkit-text-stroke-color: #FAD202 !important;
    -webkit-text-stroke: thin;
...
.explore-images .img-stripe {
    width: calc(50% - 15px);
}

.explore-images .stripe1 {
...
@font-face {
    font-family:"Neue Machina";
    src:url(./assets/fonts/Neue-Machina-Light.ttf) format("truetype");
    font-weight:400;
...
@font-face {
    font-family:"Neue Machina";
    src:url(./assets/fonts/Neue-Machina-Regular.ttf) format("truetype");
    font-weight:500;
    font-display:fallback;
    font-style:normal
}
...
@font-face {
    font-family:"Neue Machina";
    src:url(./assets/fonts/Neue-Machina-Ultrabold.ttf) format("truetype");
    font-weight:800;
    font-display:fallback;
    font-style:normal
}
